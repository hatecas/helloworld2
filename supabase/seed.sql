...
insert into "user" ("userEmail", "userPassword", "userName", "userNickname", "userGender", "userBirth", "userPhone", "createDate", "userAvailable") values
  ('demo@gmail.com', '03ac674216f3e15c761ee1a5e255f067953623c8b388b4459e13f978d7c846f4', '한제인', '제인', 'F', '1995-04-12', '010-1234-5678', '2026-01-14T16:11:02.558Z', 'Y'),
  ('minho@gmail.com', '03ac674216f3e15c761ee1a5e255f067953623c8b388b4459e13f978d7c846f4', '강민호', '민호', 'M', '1996-09-01', '010-2222-3333', '2026-01-24T16:11:02.558Z', 'Y'),
  ('soyul@gmail.com', '03ac674216f3e15c761ee1a5e255f067953623c8b388b4459e13f978d7c846f4', '배소율', '소율', 'F', '1997-02-20', '010-4444-5555', '2026-02-03T16:11:02.558Z', 'Y'),
  ('dain@gmail.com', '03ac674216f3e15c761ee1a5e255f067953623c8b388b4459e13f978d7c846f4', '문다인', '다인', 'F', '1998-11-30', '010-6666-7777', '2026-02-13T16:11:02.558Z', 'Y');
...
insert into "dotoriC" ("userNickname", "dotoriCharge", "dotoriChargeDate", "dotoriChargeMethod", "dotoriPrice") values
  ('제인', 100, '2026-01-14T16:11:02.558Z', '회원가입 축하 포인트', '0'),
  ('민호', 100, '2026-01-24T16:11:02.558Z', '회원가입 축하 포인트', '0'),
  ('소율', 100, '2026-02-03T16:11:02.558Z', '회원가입 축하 포인트', '0'),
  ('다인', 100, '2026-02-13T16:11:02.558Z', '회원가입 축하 포인트', '0');
...
insert into "store" ("seq", "category", "productName", "contentPath", "productPrice") values
  ...
  (95, 'skin', '기본 스킨', 'rgb(42, 140, 168)', '0'),
  (96, 'skin', '검정', 'black', '10'),
  (97, 'skin', '빨강', 'red', '10'),
  (98, 'skin', '노랑', 'yellow', '10'),
  (99, 'skin', '초록', 'green', '10'),
  (100, 'skin', '회색', 'grey', '10'),
  (101, 'skin', '라임', 'lime', '10'),
  (102, 'skin', '하양', 'white', '10'),
  (103, 'skin', '보라', 'purple', '10'),
  (104, 'skin', '파랑', 'blue', '10'),
  (105, 'skin', '네이비', 'navy', '10'),
  (106, 'menu', '기본 메뉴', 'rgb(42, 140, 168)', '0'),
  (107, 'menu', '검정', 'black', '10'),
  (108, 'menu', '빨강', 'red', '10'),
  (109, 'menu', '노랑', 'yellow', '10'),
  (110, 'menu', '초록', 'green', '10'),
  (111, 'menu', '회색', 'grey', '10'),
  (112, 'menu', '라임', 'lime', '10'),
  (113, 'menu', '하양', 'white', '10'),
  (114, 'menu', '보라', 'purple', '10'),
  (115, 'menu', '파랑', 'blue', '10'),
  (116, 'menu', '네이비', 'navy', '10');
...
insert into "userStorage" ("userNickname", "category", "productName", "contentPath", "buy_date", "allocation") values
  ('제인', 'minimi', '기본 미니미', '/resources/images/default/defaultMinimiIcon.gif', '2026-01-14T16:11:02.558Z', 1),
  ('제인', 'skin', '기본 스킨', 'rgb(42, 140, 168)', '2026-01-14T16:11:02.558Z', 1),
  ('제인', 'menu', '기본 메뉴', 'rgb(42, 140, 168)', '2026-01-14T16:11:02.558Z', 1),
  ('민호', 'minimi', '기본 미니미', '/resources/images/default/defaultMinimiIcon.gif', '2026-01-14T16:11:02.558Z', 1),
  ('민호', 'skin', '기본 스킨', 'rgb(42, 140, 168)', '2026-01-14T16:11:02.558Z', 1),
  ('민호', 'menu', '기본 메뉴', 'rgb(42, 140, 168)', '2026-01-14T16:11:02.558Z', 1),
  ('소율', 'minimi', '기본 미니미', '/resources/images/default/defaultMinimiIcon.gif', '2026-01-14T16:11:02.558Z', 1),
  ('소율', 'skin', '기본 스킨', 'rgb(42, 140, 168)', '2026-01-14T16:11:02.558Z', 1),
  ('소율', 'menu', '기본 메뉴', 'rgb(42, 140, 168)', '2026-01-14T16:11:02.558Z', 1),
  ('다인', 'minimi', '기본 미니미', '/resources/images/default/defaultMinimiIcon.gif', '2026-01-14T16:11:02.558Z', 1),
  ('다인', 'skin', '기본 스킨', 'rgb(42, 140, 168)', '2026-01-14T16:11:02.558Z', 1),
  ('다인', 'menu', '기본 메뉴', 'rgb(42, 140, 168)', '2026-01-14T16:11:02.558Z', 1),
  ('제인', 'skin', '빨강', 'red', '2026-07-13T16:11:02.558Z', 0),
  ('제인', 'menu', '빨강', 'red', '2026-07-13T16:11:02.558Z', 0),
  ('제인', 'skin', '네이비', 'navy', '2026-07-13T16:11:02.558Z', 0),
  ('제인', 'menu', '네이비', 'navy', '2026-07-13T16:11:02.558Z', 0),
  ('제인', 'skin', '보라', 'purple', '2026-07-13T16:11:02.558Z', 0),
  ('제인', 'menu', '보라', 'purple', '2026-07-13T16:11:02.558Z', 0),
  ('제인', 'minimi', '슬라임', '/resources/images/minimi/slimeIcon.gif', '2026-07-18T16:11:02.558Z', 0),
  ('제인', 'minimi', '주황 버섯', '/resources/images/minimi/orangeMushroomIcon.gif', '2026-07-18T16:11:02.558Z', 0),
  ('제인', 'minimi', '스타 픽시', '/resources/images/minimi/starPixieIcon.gif', '2026-07-18T16:11:02.558Z', 0);
...
글도 써 보고 미니룸도 꾸며 보세요.', '2026-07-03T16:11:02.558Z', '2026-07-03T16:11:02.558Z'),
  ('민호', 'defaultProfile.png', '오늘도 코딩 중.', '2026-07-03T16:11:02.558Z', '2026-07-03T16:11:02.558Z'),
  ('소율', 'defaultProfile.png', '음악과 함께하는 하루', '2026-07-03T16:11:02.558Z', '2026-07-03T16:11:02.558Z'),
  ('다인', 'defaultProfile.png', '사진 찍는 걸 좋아합니다.', '2026-07-03T16:11:02.558Z', '2026-07-03T16:11:02.558Z');

-- miniHomeTitle (4)
insert into "miniHomeTitle" ("userNickname", "title", "update_date") values
  ('제인', '제인의 미니홈피에 오신 걸 환영합니다.', '2026-07-23T16:11:02.558Z'),
  ('민호', '민호의 미니홈피', '2026-07-23T16:11:02.558Z'),
  ('소율', '소율의 작은 방', '2026-07-23T16:11:02.558Z'),
  ('다인', '다인의 사진 창고', '2026-07-23T16:11:02.558Z');
...
많은 이용 부탁드립니다.', '2026-07-26T16:11:02.558Z', '2026-07-26T16:11:02.558Z', 'N'),
  (2, '관리자', '도토리 충전 이벤트', '이번 달 도토리 충전 시 10% 추가 적립 이벤트를 진행합니다.', '2026-07-27T16:11:02.558Z', '2026-07-27T16:11:02.558Z', 'N'),
  (3, '관리자', 'BGM 신곡 업데이트', '추억의 명곡 14곡이 새로 추가되었습니다. 상점에서 확인해 주세요.', '2026-07-28T16:11:02.558Z', '2026-07-28T16:11:02.558Z', 'N'),
  (4, '관리자', '미니미 신상 입고', '미니미 70여 종이 상점에 새로 들어왔습니다.', '2026-07-29T16:11:02.558Z', '2026-07-29T16:11:02.558Z', 'N'),
  (5, '관리자', '서버 점검 안내', '매주 화요일 새벽 2시 ~ 4시 정기 점검이 진행됩니다.', '2026-07-30T16:11:02.558Z', '2026-07-30T16:11:02.558Z', 'N'),
  (6, '관리자', '개인정보 처리방침 개정 안내', '개인정보 처리방침이 일부 개정되었습니다.', '2026-07-31T16:11:02.558Z', '2026-07-31T16:11:02.558Z', 'N'),
  (7, '관리자', '일촌 신청 기능 개선', '일촌 신청 및 수락 흐름이 더 편해졌습니다.', '2026-08-01T16:11:02.558Z', '2026-08-01T16:11:02.558Z', 'N');
...
insert into "board" ("seq", "userNickname", "title", "content", "imagePath", "hits", "create_date", "update_date", "del_yn", "openScope") values
  (1, '제인', '첫 게시글입니다', '미니홈피 게시판 기능을 테스트해 봅니다.<br>잘 동작하네요!', '', 3, '2026-08-02T16:11:02.558Z', '2026-08-02T16:11:02.558Z', 'N', 1),
  (2, '제인', '주말에 다녀온 카페', '분위기가 정말 좋았어요. 다음에 또 가려고요.', '', 5, '2026-08-01T16:11:02.558Z', '2026-08-01T16:11:02.558Z', 'N', 1),
  (3, '제인', '요즘 듣는 노래', 'BGM 으로 걸어둔 곡들 추천합니다.', '', 11, '2026-07-29T16:11:02.558Z', '2026-07-29T16:11:02.558Z', 'N', 1),
  (4, '민호', 'Next.js 로 옮기는 중', 'Spring MVC 로 만들었던 걸 통째로 옮기고 있습니다.', '', 3, '2026-08-02T16:11:02.558Z', '2026-08-02T16:11:02.558Z', 'N', 1),
  (5, '민호', '오늘의 회고', '생각보다 JSP 가 많았다...', '', 15, '2026-07-27T16:11:02.558Z', '2026-07-27T16:11:02.558Z', 'N', 1),
  (6, '다인', '사진 정리', '사진첩에 사진 몇 장 올렸어요.', '', 7, '2026-07-31T16:11:02.558Z', '2026-07-31T16:11:02.558Z', 'N', 1);
...
insert into "boardCMT" ("boardSeq", "userNickname", "content", "create_date", "update_date", "openScope") values
  (1, '민호', '오 잘 되네요!', '2026-08-02T13:11:02.558Z', '2026-08-02T13:11:02.558Z', 1),
  (1, '제인', '감사합니다 :)', '2026-08-02T15:11:02.558Z', '2026-08-02T15:11:02.558Z', 1);

-- diary (4)
insert into "diary" ("seq", "userNickname", "title", "content", "hits", "create_date", "update_date", "diary_date", "del_yn", "openScope") values
  (1, '제인', '오늘의 일기', '미니홈피를 다시 만들었다. 옛날 생각이 많이 났다.', 0, '2026-08-02T16:11:02.558Z', '2026-08-02T16:11:02.558Z', '2026-08-02', 'n', 1),
  (2, '제인', '어제의 일기', '오랜만에 친구들과 통화했다.', 0, '2026-08-01T16:11:02.558Z', '2026-08-01T16:11:02.558Z', '2026-08-01', 'n', 1),
  (3, '제인', '지난 주말', '집에서 푹 쉬었다.', 0, '2026-07-30T16:11:02.558Z', '2026-07-30T16:11:02.558Z', '2026-07-30', 'n', 1),
  (4, '민호', '이사 완료', '드디어 마이그레이션 끝!', 0, '2026-08-02T16:11:02.558Z', '2026-08-02T16:11:02.558Z', '2026-08-02', 'n', 1);
...
insert into "diaryCMT" ("diarySeq", "userNickname", "content", "create_date", "openScope") values
  (1, '민호', '나도 그때 생각난다 ㅎㅎ', '2026-08-02T14:11:02.558Z', 1);

-- album (3)
insert into "album" ("seq", "userNickname", "title", "content", "imagePath", "create_date", "update_date", "del_yn", "openScope") values
  (1, '제인', '강아지 사진', '산책 나갔다가 찍었어요.', 'albumPuppy.jpg', '2026-08-01T16:11:02.558Z', '2026-08-01T16:11:02.558Z', 'N', 1),
  (2, '제인', '첫 앨범', '기본 앨범 이미지입니다.', 'albumImg1.jpg', '2026-07-28T16:11:02.558Z', '2026-07-28T16:11:02.558Z', 'N', 1),
  (3, '다인', '고양이', '동네 고양이', 'albumPuppy.jpg', '2026-07-31T16:11:02.558Z', '2026-07-31T16:11:02.558Z', 'N', 1);
...
insert into "visit" ("userNickname", "targetNickname", "content", "openScope", "create_date", "update_date") values
  ('민호', '제인', '방명록 첫 글!
자주 놀러올게요.', 1, '2026-08-01T16:11:02.558Z', '2026-08-01T16:11:02.558Z'),
  ('다인', '제인', '홈피 잘 보고 갑니다 :)', 1, '2026-07-31T16:11:02.558Z', '2026-07-31T16:11:02.558Z'),
  ('제인', '민호', '나도 방문 도장 쾅', 1, '2026-08-02T16:11:02.558Z', '2026-08-02T16:11:02.558Z');
...
insert into "friends" ("userNickname", "friendNickname", "fStatus", "del_yn", "createDate") values
  ('제인', '민호', 1, 'N', '2026-06-03T16:11:02.558Z'),
  ('다인', '민호', 1, 'N', '2026-06-18T16:11:02.558Z'),
  ('소율', '제인', 0, 'N', '2026-07-31T16:11:02.558Z');

-- friendCMT (2)
insert into "friendCMT" ("userNickname", "friendNickname", "content", "createDate", "del_yn") values
  ('민호', '제인', '일촌평 1호 남기고 갑니다 :)', '2026-07-28T16:11:02.558Z', 'n'),
  ('제인', '민호', '홈피 예쁘게 잘 꾸몄네!', '2026-07-30T16:11:02.558Z', 'n');

-- loginStatus (4)
insert into "loginStatus" ("userNickname", "status", "last_seen") values
  ('제인', '1', '2026-08-02T16:11:02.558Z'),
  ('민호', '1', '2026-08-02T16:11:02.558Z'),
  ('소율', '0', '2026-07-30T16:11:02.558Z'),
  ('다인', '0', '2026-07-30T16:11:02.558Z');
